...
import { Grid, FormControl, CircularProgress, InputLabel, OutlinedInput, Divider, Skeleton } from '@mui/material'
import dynamic from 'next/dynamic'
import { FormPropsType } from '@/types'

const ErrorComponent = dynamic(() => import('@/components/Error/Error'), { loading: () => <Skeleton variant="text" /> })
